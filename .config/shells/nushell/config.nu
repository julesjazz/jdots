# TODO: revisit nushell once they've fixed IDE parsing 
...
$env.HISTFILE = $env.XDG_CONFIG_HOME + "/shells/.history"
$env.HISTSIZE = 10000
...
if ($env.XDG_CONFIG_HOME + "/shells/.z" | path exists) {
    $env._Z_DATA = $env.XDG_CONFIG_HOME + "/shells/.z"
